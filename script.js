...
function handleKeyDown(keyEvent) {
    ...
    //     heroSphere.position.x += heroSphere.position.x - currentLane;
    var difference = currentLane - heroSphere.position.x;
    //     console.log(heroSphere.position.x+difference/2);
    //     console.log(currentLane);
    heroSphere.position.x = heroSphere.position.x + difference / 6;
}
...
function addHero() {
    ...
    heroSphere.matrixAutoUpdate = true;
    ...
    treesInPath.forEach(function(element, index) {
        ...
        if(treePos.z > 6 && oneTree.visible) { //gone out of our view zone
            ...
            if(treePos.distanceTo(heroSphere.position) <= 0.5) {
                ...
                heroSphere.scale.y = heroSphere.scale.y / 1.25;
                //                 console.log(treePos)
                hasCollided = true;
                explode();
            }
